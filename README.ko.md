...
> 🔥 **핫 (2026-07):** **DeepSeek-V4-Flash-0731** 정식 버전 출시 — 에이전트 성능이 대폭 강화되어 활성화 파라미터가 훨씬 적은데도 V4-Pro (Preview)를 능가 (Terminal Bench 82.7 vs 72.1, DeepSWE 54.4 vs 12.8, Toolathlon 70.3 vs 55.9). MoA의 툴 계층·의견 계층 주력 Flash가 같은 비용으로 크게 강화됐습니다.
