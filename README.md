...
> 🔄 **LongLoop (200h+ unattended):** Keep your project iterating for days — no forgetting, no stopping, no repeating. The concierge wakes every round, routes through the full MoA pipeline, and writes progress to disk. One command to run it on your project: **[▶ Get started →](docs/LongLoop.md)**
